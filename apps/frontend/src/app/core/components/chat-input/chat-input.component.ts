...
@Component({
  ...
  template: `
    <div class="w-full max-w-4xl mx-auto flex items-center gap-3 p-2">
      ...
      <!-- Input Container -->
      <div
        class="flex-1 bg-gray-800/80 backdrop-blur-sm rounded-full border border-gray-700/50 focus-within:border-blue-500/50 focus-within:bg-gray-800 transition-all flex items-center px-4 py-3 shadow-lg"
      >
        <input
          type="text"
          [ngModel]="value()"

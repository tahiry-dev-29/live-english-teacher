...
const TRANSLATIONS: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    'voices.model_default_hint':
      'Default model — add an API key to load live models.',
    'voices.loading_voices': 'Loading live voices…',
    'voices.no_voices_available': 'No voices available for this provider.',
    'voices.hint_no_key':
      'Using the server key. Add your own key below to use custom credentials.',
  ...
  fr: {
    ...
    'voices.model_default_hint':
      'Modèle par défaut — ajoutez une clé API pour charger les modèles en direct.',
    'voices.loading_voices': 'Chargement des voix en direct…',
    'voices.no_voices_available': 'Aucune voix disponible pour ce fournisseur.',
    'voices.hint_no_key':
      'Utilisation de la clé du serveur. Ajoutez votre propre clé ci-dessous pour utiliser vos identifiants.',
  ...
  es: {
    ...
    'voices.model_default_hint':
      'Modelo predeterminado: agregue una clave API para cargar modelos en vivo.',
    'voices.loading_voices': 'Cargando voces en vivo…',
    'voices.no_voices_available':
      'No hay voces disponibles para este proveedor.',
    'voices.hint_no_key':
      'Usando la clave del servidor. Agregue su propia clave a continuación para usar credenciales personalizadas.',

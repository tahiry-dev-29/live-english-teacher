...
import { AudioRecorderService } from '@features/voice-call/services/audio-recorder-service';
...
export class AudioRecorderComponent {
  ...
  async startRecording() {
    ...
    try {
      ...
      this.logger.error(MESSAGES.log.recordingStartFailed, error);
    }
  }
  ...
  async stopRecording() {
    ...
    try {
      ...
      this.logger.error(MESSAGES.log.recordingStopFailed, error);
      this.isRecording.set(false);
      this.recordingStateChange.emit(false);
    }
  }
